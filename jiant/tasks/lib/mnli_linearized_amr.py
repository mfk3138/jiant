...
class Example(BaseExample):
    guid: str
    premise: str
    premise_linearized_amr: str
    hypothesis: str
    hypothesis_linearized_amr: str
    label: str
...
class MnliLinearizedAMRTask(GlueMixin, Task):
    Example = Example
        ...
        for (i, line) in enumerate(lines):
            examples.append(
                Example(
                    ...
                    guid="%s-%s" % (set_type, i),
                    premise=line["premise"]["snt"],
                    premise_linearized_amr=" ".join(line["premise"]["linearized_amr"]),
                    hypothesis=line["hypothesis"]["snt"],
                    hypothesis_linearized_amr=" ".join(line["hypothesis"]["linearized_amr"]),
